...
From the results section, it wasn't immediately clear whether Ward et al. did a repeated measures ANOVA here. But when you include this information in the model, the $F$ and $p$.
...
```{r}
compareValues(reportedValue = 10.10, obtainedValue = t_div$statistic)
```
